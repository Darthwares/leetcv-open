...
import ShareButton from "./socialMediaShare";

export default function ProviderBanner() {
  const t = useTranslations("ResumeEditor");
  return (
    <div className="my-3 w-full max-w-7xl relative isolate flex items-center justify-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      <div
